...
var jsIndividualScripts = lazypipe()
  .pipe(browserify, {debug: true, insertGlobals : true, transform: [babelify.configure({
      presets: ['es2015']
    })]
  })
  .pipe(plumber, {errorHandler: plumberErrorHandler})
  .pipe(newer, { dest: config.destJS })
